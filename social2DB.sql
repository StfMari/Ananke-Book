...
--
-- Host: social2.cvzu4xrxvkdz.eu-south-1.rds.amazonaws.com    Database: sys
-- ------------------------------------------------------
...
CREATE TABLE `friendship` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_user1_idx` (`user1_id`),
  KEY `fk_user2_idx` (`user2_id`),
...
CREATE TABLE `post_reaction` (
  ...
  `post_id` int NOT NULL,
  `user_id` int NOT NULL,
  `reaction_type` enum('SCIOC','LIKE','WOW','LOVE','BAD','ANGRY','CLAP') NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_user_auth_idx` (`user_id`),
  KEY `fk_post_idx` (`post_id`),
  CONSTRAINT `fk_post_reacting` FOREIGN KEY (`post_id`) REFERENCES `post` (`id`),
  CONSTRAINT `fk_user_auth` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2021-02-26 09:26:58',NULL),('diagnostics.include_raw','OFF','2021-02-26 09:26:58',NULL),('ps_thread_trx_info.max_length','65535','2021-02-26 09:26:58',NULL),('statement_performance_analyzer.limit','100','2021-02-26 09:26:58',NULL),('statement_performance_analyzer.view',NULL,'2021-02-26 09:26:58',NULL),('statement_truncate_len','64','2021-02-26 09:26:58',NULL);
...
INSERT INTO `user` VALUES (1,'Stefano','Bestetti','StefanoBBestetti','stefano.bestetti94@gmail.com','Pegaso74','europe','male',27,'1994-05-27'),(2,'Stefano','Marinoni','Stf','stefano@gmail.com','ciao','europe','male',NULL,NULL),(3,'Sara','De Monaco','saras','sdm@gmail.com','muchwow',NULL,NULL,NULL,NULL);
...
-- Dump completed on 2021-03-09 14:21:12
